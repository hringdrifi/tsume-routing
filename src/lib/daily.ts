...
const DAYS:DailyDefinition[]=[
  ...
  {title:'Long Row',board:{width:154,height:68},matrix:{rows:1,cols:6,diodeDirection:'ROW2COL'},keys:grid(1,6,[16,36,56,76,96,116],[27],0),mcu:{x:135,y:20,roles:['COL3','COL0','ROW0','COL5','COL2','COL4','COL1']},keepouts:[{id:'KO1',type:'rect',x:49,y:38,width:35,height:11},{id:'KO2',type:'rect',x:120,y:2,width:12,height:10}]},
